...
function aquila_chk_pluginSupport_render() { 
	$options = get_option('aquila_settings');
	if (isset($options['aquila_chk_pluginSupport'])) { 
		$aquilaPluginSupport = $options['aquila_chk_pluginSupport']; 
	} else { 
...
function aquila_chk_dashBoxes_render() { 
	$options = get_option('aquila_settings');
	if (isset($options['aquila_chk_dashBoxes'])) { 
		$aquilaDashBoxes = $options['aquila_chk_dashBoxes']; 
	} else { 
		$aquilaDashBoxes = 0; 
	};
	?>
...
function aquila_chk_postBlog_render() { 
	$options = get_option('aquila_settings');
	if (isset($options['aquila_chk_postBlog'])) { 
		$aquilaPostBlog = $options['aquila_chk_postBlog']; 
	} else { 
		$aquilaPostBlog = 0; 
	};
	?>
...
function aquila_chk_hideFooter_render() { 
	$options = get_option('aquila_settings');
	if (isset($options['aquila_chk_hideFooter'])) { 
		$aquilaHideFooter = $options['aquila_chk_hideFooter']; 
	} else { 
		$aquilaHideFooter = 0; 
	};
	?>
...
function aquila_chk_showNag_render() { 
	$options = get_option('aquila_settings');
	if (isset($options['aquila_chk_showNag'])) { 
		$aquilaShowNag = $options['aquila_chk_showNag'];
	} else { 
		$aquilaShowNag = 0; 
	};
	?>
